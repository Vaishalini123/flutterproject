...
class TempStaffIdCard extends StatefulWidget {
  const TempStaffIdCard({Key? key});

  @override
  _TempStaffIdCardState createState() => _TempStaffIdCardState();
}

class _TempStaffIdCardState extends State<TempStaffIdCard> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        if (response.data is String) {
          ...
          if(staffIdModel!=null && staffIdModel!.ATS_TDATE!=null) {
            ...
            if (parsedDateTime.compareTo(now) >= 0 && staffIdModel!.EM_DIGITAL_IDCARD_STATUS == "1") {
              ...
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => const IDCardErrorMessage()));
            }
          }else{
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => ApplyIDcard()));
          }
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              if (staffIdModel != null && staffIdModel!.ASP_PHOTO != null)
                                Container(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "${staffIdModel!.ATS_FDATE ?? ''} to ${formatDateToCustomFormat(staffIdModel!.ATS_TDATE?.toString()) ?? ''}",
                                      style: const TextStyle(
                                          color: Colors.black,
                                          fontSize: 14,
                                          fontWeight: FontWeight.bold
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(width: 9), // Adjust the width as needed
                                    const Text(
                                      ":",
                                      style: TextStyle(
                                        color: Colors.black,
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(width: 25), // Adjust the width as needed
                                    const Text(
                                      ":",
                                      style: TextStyle(
                                        color: Colors.black,
    ...
    try {
      ...
      if (response.statusCode == 200) {
        if (response.data is String) {
          ...
          setState(() {
            staffIdModel = StaffIdCardModel.fromJson(jsonMap);
            _employeeNameController.text = staffIdModel!.ATSD_NAME ?? '';
            _employeeDesignationController.text = staffIdModel!.ATSD_DESIGNATION ?? '';
            _employeeCampusController.text = staffIdModel?.DD_DEPT_DETAIL ?? '';
